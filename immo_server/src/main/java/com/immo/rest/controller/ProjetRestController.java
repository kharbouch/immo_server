/*
 * Created on 29 déc. 2015 ( Time 20:53:08 )
...
public class ProjetRestController {
    ...
    @ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Projet findOne(@PathVariable("id") Long id) {
    ...
    @ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public Projet update(@PathVariable("id") Long id, @RequestBody Projet projet) {
